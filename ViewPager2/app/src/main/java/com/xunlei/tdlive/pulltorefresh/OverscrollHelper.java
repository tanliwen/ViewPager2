...
import com.xunlei.tdlive.pulltorefresh.PullToRefreshBase.State;
...
public final class OverscrollHelper {
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (PullToRefreshBase.DEBUG) {
					android.util.Log.d(LOG_TAG, "OverScroll. DeltaX: " + deltaX + ", ScrollX: " + scrollX + ", DeltaY: " + deltaY
				...
				if (newScrollValue < (0 - fuzzyThreshold)) {
					...
					if (mode.showHeaderLoadingLayout()) {
						...
						view.setScrollValue((int) (scaleFactor * (currentScrollValue + newScrollValue)));
					}
					...
					if (mode.showFooterLoadingLayout()) {
						...
						view.setScrollValue((int) (scaleFactor * (currentScrollValue + newScrollValue - scrollRange)));
					}
	...
	static boolean isAndroidOverScrollEnabled(android.view.View view) {
		return view.getOverScrollMode() != android.view.View.OVER_SCROLL_NEVER;
	}
}
